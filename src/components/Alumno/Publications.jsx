...
export const Publications = () => {
  ...
  const userPublications = publications.filter(
    (publication) => publication.publisher === currentUser,
  );
  ...
  const publicationsTable =
    rol === 'administrador' ? publications : userPublications;
      ...
      <div className="center-project">
        <table className="tb-project">
          <tr className="th-project">
            <td className="td-project">Imagen</td>
            <td className="td-project">Tipo</td>
            <td className="td-project">Titulo</td>
            <td className="td-project">Descripcion</td>
