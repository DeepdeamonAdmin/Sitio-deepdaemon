...
export const FormEditarAlumno = () => {
    ...
    const obtenerProject = async () => {
      try {
        ...
        const queryRef = query(
          projectRef,
          where('autores', 'array-contains', alumno.nombre),
        );
  ...
  const handleSave = (e) => {
    ...
    if (alumno.rol === 'alumno' || alumno.rol === 'externo') {
      data.idWork = 'student';
    }
  ...
  return (
    <div className="container">
      <div className="app-title">
        ...
        {alumno.rol === 'administrador' && <h2>Editar Líder</h2>}
        <hr />
      </div>
      ...
      <div className="row">
        ...
        <div className="col mb-3">
          <div className="card">
            ...
            <button className="btn btn-primary" onClick={handleContra}>
              Cambiar
            </button>
          </div>
        </div>
